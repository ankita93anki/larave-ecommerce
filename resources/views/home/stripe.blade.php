...
<div class="container">
    ...
    <h1 style="text-align: center; font-size: 14px;padding-bottom:28px">Pay Using Your Card Total Amount-${{$totalprice}}</h1>
            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <input type="submit" name="" value="Pay Now">Pay Now($100)
